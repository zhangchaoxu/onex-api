...
import com.nb6868.onex.portal.modules.crm.dto.ProductCategoryDTO;
import com.nb6868.onex.portal.modules.crm.excel.ProductCategoryExcel;
...
public class ProductCategoryController {
    ...
    @DataSqlScope(tableAlias = "crm_product_category",tenantFilter = true)
    @GetMapping("list")
    @ApiOperation("列表")
