...
import com.nb6868.onex.portal.modules.shop.excel.ReceiverExcel;
import com.nb6868.onex.portal.modules.shop.service.ReceiverService;
...
public class ReceiverController {
    ...
    @DataSqlScope(tableAlias = "shop_receiver", tenantFilter = true)
    @GetMapping("list")
    @ApiOperation("列表")
